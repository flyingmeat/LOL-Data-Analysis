...
later.date.UTC();
var textSched = later.parse.text('every 5 seconds'); // every 2 days
      ...
      fs.readFile('./clean_data/champion.txt', function(err, data) {
        ...
        s3.putObject({
          ...
          var snsParams = {
            ...
            Message: "champion.txt and team.txt are ready to use!"
          };
...
var timer = later.setTimeout(cleanDataAndUploadToS3, textSched);